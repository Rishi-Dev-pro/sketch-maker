...
| **TASK-104** | Polyline extraction & curve simplification (Ramer-Douglas-Peucker) | `NOT_STARTED` | P1 | TASK-103.9 | `packages/stroke-engine/simplification.ts` | Convert raw contours to clean Bézier/polylines | Not tested |
