...
| **TASK-103** | Initial facial landmark & structural contour extraction | `IN_PROGRESS` | P1 | TASK-102 | `packages/structural-analysis/*`, `packages/shared-types/*` | Contract foundation complete (FeatureVisibility, HeadPose, SubjectAnalysisResult); landmark engine pending | Typecheck & existing tests pass (0 regressions) |
